...
10. Two options
  ...
  (https://github.com/B1129E5/LP-RDI/blob/main/Documentations/Images/Image08.png)
   1. In **Runtime Environment**, choose **Select from existing** and select **Powershell 7-2**
   (https://github.com/B1129E5/LP-RDI/blob/main/Documentations/Images/Image22.png)

    ![alt text](https://github.com/B1129E5/LP-RDI/blob/main/Documentations/Images/Image23.png)

1.   Click **Review +  Create** and **Create**
2.   Copy/paste the PowerShell code form the file LPDI_Dashboard_v1.0_RunBook_AutomationAccount.ps1 located in the **Scripts** folder
