...
Function Post-DataToLogAnalytics($customerId, $sharedKey, $body, $logType, $TimeStampField)
{
    ...
    $uri = "$endpoint_uri/dataCollectionRules/$dcrImmutableId/streams/$($logType)?api-version=2023-01-01"
...
#Logs ingestion URI for the DCR
    
    $endpoint_uri = "https://dce-lpdi-65yd.northeurope-1.ingest.monitor.azure.com" 

#the immutableId property of the DCR object

    $dcrImmutableId = "dcr-3c8dedaed3e54f21944ee2e5270f3743" 
...
if (!$ClientID) {
        ...
        #Get the bearer token using managed identity
        $result = Invoke-WebRequest -Uri 'http://169.254.169.254/metadata/identity/oauth2/token?api-version=2018-02-01&resource=https%3A%2F%2Fmanagement.azure.com%2F' `
